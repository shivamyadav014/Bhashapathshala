...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'BhashaPathshala'); ?></title>
        ...
        <div id="nav" class="collapse navbar-collapse">
            <ul class="navbar-nav ms-auto align-items-lg-center">
                ...
                <?php else: ?>
                    ...
                    <li class="nav-item"><a class="btn btn-primary ms-lg-2" href="<?php echo e(route('register')); ?>">Register</a></li>
                <?php endif; ?>
            </ul>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-2 sidebar p-0">
            <div class="p-3 border-bottom">
                <small class="text-muted fw-bold text-uppercase"><?php echo e(ucfirst(auth()->user()->role)); ?> Dashboard</small>
            </div>

            <?php $role = auth()->user()->role; ?>

            <a href="<?php echo e(route($role.'.dashboard')); ?>" class="sidebar-link"><i class="fas fa-table-columns"></i> Dashboard</a>

            <?php if($role === 'admin'): ?>
                <a href="<?php echo e(route('admin.courses')); ?>" class="sidebar-link"><i class="fas fa-layer-group"></i> Courses</a>
                <a href="<?php echo e(route('admin.users')); ?>" class="sidebar-link"><i class="fas fa-users"></i> Users</a>
                <a href="<?php echo e(route('admin.reports')); ?>" class="sidebar-link"><i class="fas fa-chart-line"></i> Reports</a>
            <?php endif; ?>

            <?php if($role === 'instructor'): ?>
                <a href="<?php echo e(route('instructor.courses')); ?>" class="sidebar-link"><i class="fas fa-chalkboard-user"></i> My Courses</a>
            <?php endif; ?>

            <?php if($role === 'student'): ?>
                <a href="<?php echo e(route('courses.index')); ?>" class="sidebar-link"><i class="fas fa-compass"></i> Browse courses</a>
                <a href="<?php echo e(route('student.my-courses')); ?>" class="sidebar-link"><i class="fas fa-book-open"></i> My courses</a>
                <a href="<?php echo e(route('student.performance')); ?>" class="sidebar-link"><i class="fas fa-chart-simple"></i> Performance</a>
            <?php endif; ?>

            <hr>

            <a href="<?php echo e(route('profile')); ?>" class="sidebar-link"><i class="fas fa-user"></i> Profile</a>
            <a href="<?php echo e(route('settings')); ?>" class="sidebar-link"><i class="fas fa-gear"></i> Settings</a>
        </div>
...
<?php /**PATH C:\Users\shiva\OneDrive\Desktop\laravel prfoject\resources\views/layouts/app.blade.php ENDPATH**/ ?>